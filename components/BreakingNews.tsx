  ...
  return (
      <View style={styles.container}  >
          ...
          <View style={styles.slideWrapper}>
              <Animated.FlatList ref={ref} data={data} keyExtractor={(_, index) => `list_item${index}`}
         ...
         <SliderItem sliderItem={item} index={index} scrollX={scrollX}/>
              ...
              />
              <Pagination items={newsList} scrollX={scrollX} paginationindex={paginationIndex}></Pagination>
          </View>
    </View>
  )
}
